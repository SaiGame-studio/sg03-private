...
{
    [CustomEditor(typeof(GhostDamageVfxCtrl))]
    public class GhostDamageVfxCtrlEditor : GhostVfxCtrlEditorBase
    {
        ...
        private SerializedProperty skullPopSpeed;
        private SerializedProperty skullGravity;
        ...
        private SerializedProperty wispPopSpeed;
        private SerializedProperty wispGravity;
        ...
        private void OnEnable()
        {
            ...
            this.skullPopSpeed = this.serializedObject.FindProperty("skullPopSpeed");
            this.skullGravity = this.serializedObject.FindProperty("skullGravity");
            ...
            this.wispPopSpeed = this.serializedObject.FindProperty("wispPopSpeed");
            this.wispGravity = this.serializedObject.FindProperty("wispGravity");
        ...
        private void DrawSkullSettings()
        {
            ...
            EditorGUILayout.PropertyField(this.skullPopSpeed);
            EditorGUILayout.PropertyField(this.skullGravity);
        ...
        private void DrawBloodWispSettings()
        {
            ...
            if (this.showBloodWisps)
            {
                ...
                EditorGUILayout.PropertyField(this.wispPopSpeed);
                EditorGUILayout.PropertyField(this.wispGravity);
